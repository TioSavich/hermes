...
<head>
  ...
  <script defer src="render/hermes-shell.js" data-root="./" data-app="/" data-active="incompatibility-entailment"></script>
  <style>
    :root {{ --bg:#110f08; --surface:#1a1710; --raised:#242016; --text:#d4cfc0; --muted:#9a927e; --border:#4a4233; --accent:var(--acc-negation); --danger:#d4634a; --good:#89b77a; --mono:ui-monospace,Menlo,Monaco,Consolas,monospace; }}
