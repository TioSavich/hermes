...
def load_rows() -> list[dict[str, object]]:
    goal = (
        ...
        "status:StatusString,complete_statement:Statement,source_spans:Spans},"
        ...
        "findall(_{path:Path,line_start:LineStart,line_end:LineEnd,"
        "byte_start:ByteStart,byte_end:ByteEnd},"
        ...
        "get_dict(byte_start,Segment,ByteStart),get_dict(byte_end,Segment,ByteEnd)),Spans)),"
