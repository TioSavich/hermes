...
def load_rows() -> list[dict[str, object]]:
    goal = (
        ...
        "byte_start:ByteStart,byte_end:ByteEnd,sha256:Sha,decoder:Decoder},"
        ...
        "get_dict(sha256,Segment,Sha),get_dict(decoder,Segment,Decoder)),Spans),"
        ...
        "get_dict(decoder,SourceSegment,SourceDecoder)),"
        ...
        "sha256:StatementSha,decoder:StatementDecoder},"
        ...
        "get_dict(decoder,StatementSegment,StatementDecoder)),"
        "StatementSpans)),"
