...
main :-
    ...
    expect_only_claim("98 + 3 > 100",
                      arithmetic_comparison(98+3,greater,100)),
    expect_verdict("98 + 3 > 100", "holds"),
    expect_only_claim("0.909 > 0.91",
                      arithmetic_comparison(0.909,greater,0.91)),
    expect_verdict("0.909 > 0.91", "refuted"),
    expect_no_claim("1 ≤ 2"),
    expect_no_claim("2 ≥ 1"),
    expect_no_claim("1 ≠ 2"),
