...
The denominator is every explicit quantitative-result statement in the 64
...
def render_registry() -> str:
    ...
    # happen to them.
    if len(reports) != 64:
        raise RuntimeError(f"expected 64 top-level research reports, found {len(reports)}")
    measurements = sorted(
