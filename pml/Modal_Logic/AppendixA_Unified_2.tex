% ============================================================
% Commentary — philosophical reflection, not code-report.
% This appendix proposes a mapping between the twelve-operator
% PML vocabulary and embodied/Hegelian phenomenology. Its own
% abstract flags the mapping as "interpretive, not legislative."
% The pml Prolog module defines and exercises the vocabulary;
% this appendix does not describe what the Prolog proves.
% See docs/phase5/fact-sheet-pml.md for the code-backed claims.
% ============================================================
