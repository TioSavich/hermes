% standards/im/grade_7.pl - Mappings for grade 7 CCSS/Indiana standards
...
im_grade7_lesson_standard_witness(ConceptId, Code, Witness) :-
    ...
    Witness = _{ kind: im_grade7_lesson_standard_anchor,
                 scope: closed_world_finite_im_grade7_lesson_table,
                 concept: ConceptId,
                 framework: im_lesson,
                 code: Code,
                 statement: Statement,
...
im_grade7_lesson_anchor_fact(ConceptId, Code, Statement) :-
    ...
    sub_atom(File, _, _, _, 'standards/im/grade_7.pl').
