...
decompose_witness(Number,
                  ...
                  Steps,
                  WitnessDict269) :-
    witness_dict:witness_dict(standard_1_ns_2_decomposition, closed_world_finite_standard_1_ns_2_place_value,
                              _{standard: in_1_ns_2,
                     ...
                     bound_status: BoundStatus }, WitnessDict269),
...
compose_witness(Tens,
                ...
                Steps,
                WitnessDict300) :-
    witness_dict:witness_dict(standard_1_ns_2_composition, closed_world_finite_standard_1_ns_2_place_value,
                              _{standard: in_1_ns_2,
                   ...
                   projection: tens_ones_place_value,
                   boundary: supplied_grounded_recollection_up_to_99,
                   bound_status: BoundStatus }, WitnessDict300),
    recollection_to_integer(Tens, TensCount),
    recollection_to_integer(Ones, OnesCount),
    recollection_to_integer(Number, NumberCount),
    recollection_to_integer(Ten, TenCount),
...
multiple_of_ten_witness(Number,
                        ...
                        DecompositionWitness,
                        WitnessDict339) :-
    witness_dict:witness_dict(standard_1_ns_2_multiple_of_ten, closed_world_finite_standard_1_ns_2_place_value,
                              _{standard: in_1_ns_2,
                           ...
                           decomposition_witness: DecompositionWitness }, WitnessDict339),
    recollection_to_integer(Number, NumberCount),
    recollection_to_integer(Tens, TensCount),
    recollection_to_integer(Ones, OnesCount),
    place_value_bound_status(NumberCount, BoundStatus).
...
projection_witness(Projection,
                   ...
                   DecompositionWitness,
                   WitnessDict362) :-
    witness_dict:witness_dict(standard_1_ns_2_projection, closed_world_finite_standard_1_ns_2_place_value,
                              _{standard: in_1_ns_2,
                      ...
                      boundary: supplied_grounded_recollection_up_to_99,
                      bound_status: BoundStatus,
                      decomposition_witness: DecompositionWitness }, WitnessDict362),
    recollection_to_integer(Number, NumberCount),
    place_value_bound_status(NumberCount, BoundStatus).
