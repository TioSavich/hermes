...
counting_on_witness(A,
                    ...
                    Sum,
                    Trace,
                    _{ kind: standard_1_ca_1_counting_on,
                       scope: closed_world_finite_standard_1_ca_1_within_20,
                       standard: in_1_ca_1,
...
making_ten_witness(A,
                   ...
                   Need,
                   Rest,
                   _{ kind: standard_1_ca_1_making_ten,
                      scope: closed_world_finite_standard_1_ca_1_within_20,
                      standard: in_1_ca_1,
...
decompose_to_ten_witness(Minuend,
                         ...
                         Above,
                         Rest,
                         _{ kind: standard_1_ca_1_sub_decompose_to_ten,
                            scope: closed_world_finite_standard_1_ca_1_within_20,
                            standard: in_1_ca_1,
...
fact_family_witness_(A,
                     ...
                     Sum,
                     Facts,
                     _{ kind: standard_1_ca_1_fact_family,
                        scope: closed_world_finite_standard_1_ca_1_within_20,
                        standard: in_1_ca_1,
...
doubles_near_witness(A,
    ...
    recollection_to_integer(Sum, SumCount),
    strategy_bound_status(ACount, BCount, SumCount, BoundStatus),
    Witness0 = _{ kind: standard_1_ca_1_doubles_near,
                  scope: closed_world_finite_standard_1_ca_1_within_20,
                  standard: in_1_ca_1,
