...
skip_count_witness(Operation,
                   ...
                   Trace,
                   WitnessDict89) :-
    witness_dict:witness_dict(standard_2_ns_1_skip_count_trace, closed_world_finite_standard_2_ns_1_skip_counting,
                              _{standard: in_2_ns_1,
                      operation: Operation,
                      ...
                      state_counts: StateCounts }, WitnessDict89),
