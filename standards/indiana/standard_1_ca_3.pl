...
addition_witness(Predicate,
                 ...
                 CompositionWitness,
                 WitnessDict245) :-
    witness_dict:witness_dict(standard_1_ca_3_place_value_addition, closed_world_finite_standard_1_ca_3_addition_within_100,
                              _{standard: in_1_ca_3,
                    ...
                    composition_witness: CompositionWitness }, WitnessDict245),
...
wrapper_witness(Predicate,
                ...
                BaseWitness,
                WitnessDict294) :-
    witness_dict:witness_dict(standard_1_ca_3_public_surface, closed_world_finite_standard_1_ca_3_addition_within_100,
                              _{standard: in_1_ca_3,
                   source_predicate: Predicate,
                   surface: Surface,
                   addends: _{a: A, b: B, a_count: ACount, b_count: BCount},
                   ...
                   boundary: supplied_grounded_recollections_with_finite_place_value_decomposition,
                   bound_status: BoundStatus,
                   base_witness: BaseWitness }, WitnessDict294),
    recollection_to_integer(A, ACount),
    recollection_to_integer(B, BCount),
    recollection_to_integer(Sum, SumCount),
    addition_bound_status(ACount, BCount, SumCount, BoundStatus).
