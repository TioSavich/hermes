...
decompose_witness(Number,
                  ...
                  HundredUnit,
                  WitnessDict169) :-
    witness_dict:witness_dict(standard_2_ns_2_4_decomposition, closed_world_finite_standard_2_ns_2_4_place_value,
                              _{standard: in_2_ns_2_4,
                     ...
                     subproofs: [hundreds_by_repeated_subtraction,
                                 tens_ones_by_standard_1_ns_2] }, WitnessDict169),
...
compose_witness(Hundreds,
                ...
                TensOnesValue,
                WitnessDict203) :-
    witness_dict:witness_dict(standard_2_ns_2_4_composition, closed_world_finite_standard_2_ns_2_4_place_value,
                              _{standard: in_2_ns_2_4,
                   ...
                   subproofs: [hundreds_value_by_repeated_addition,
                               ...
                               grounded_addition_of_place_values] }, WitnessDict203),
    recollection_to_integer(Hundreds, HI),
    recollection_to_integer(Tens, TI),
    recollection_to_integer(Ones, OI),
    recollection_to_integer(Number, NumberCount),
...
projection_witness(Projection,
                   ...
                   DecompositionWitness,
                   WitnessDict237) :-
    witness_dict:witness_dict(standard_2_ns_2_4_projection, closed_world_finite_standard_2_ns_2_4_place_value,
                              _{standard: in_2_ns_2_4,
                      ...
                      boundary: supplied_grounded_recollection_up_to_1000,
                      decomposition_witness: DecompositionWitness }, WitnessDict237),
    recollection_to_integer(Number, NumberCount).
