...
add_objects_witness_(GroupA,
                     ...
                     CountWitness,
                     WitnessDict209) :-
    witness_dict:witness_dict(standard_k_ca_1_3_add_objects, closed_world_finite_standard_k_ca_1_3_operations_within_10,
                              _{standard: in_k_ca_1,
                        ...
                        count_witness: CountWitness }, WitnessDict209),
...
subtract_objects_witness_(Group,
                          ...
                          CountWitness,
                          WitnessDict236) :-
    witness_dict:witness_dict(standard_k_ca_1_3_subtract_objects, closed_world_finite_standard_k_ca_1_3_operations_within_10,
                              _{standard: in_k_ca_1,
                             ...
                             bound_status: BoundStatus,
                             count_witness: CountWitness }, WitnessDict236),
...
pair_witness(Number,
             ...
             RecB,
             WitnessDict259) :-
    witness_dict:witness_dict(standard_k_ca_1_3_decomposition_pair, closed_world_finite_standard_k_ca_1_3_operations_within_10,
                              _{number: Number,
                ...
                derivation: finite_pair_enumeration_with_grounded_addition }, WitnessDict259),
...
decompose_pairs_witness_(Number,
                         ...
                         PairWitnesses,
                         WitnessDict277) :-
    witness_dict:witness_dict(standard_k_ca_1_3_decompose_pairs, closed_world_finite_standard_k_ca_1_3_operations_within_10,
                              _{standard: in_k_ca_2,
                            ...
                            bound_status: BoundStatus }, WitnessDict277),
    recollection_to_integer(Number, NumberCount),
...
complement_witness(Given,
                   ...
                   Ten,
                   WitnessDict296) :-
    witness_dict:witness_dict(standard_k_ca_1_3_complement_to_ten, closed_world_finite_standard_k_ca_1_3_operations_within_10,
                              _{standard: in_k_ca_3,
                      ...
                      bound_status: within_indiana_k_ca_3_bound }, WitnessDict296),
