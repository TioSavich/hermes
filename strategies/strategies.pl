 ...
 * strategies/math/action_automata_registry.pl, which exports
 ...
 *
 * strategies/hermeneutic_calculator.pl is the v2 legacy router: its
 ...
 * their siblings under strategies/math/) remain loadable directly with
