...
%
%   Complete machine-readable invocation-contract table for action automata.
...
action_automaton_signature(addition, round_then_adjust,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           nonnegative_integer_sum).
action_automaton_signature(addition, count_on_from_larger,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           nonnegative_integer_sum).
action_automaton_signature(addition, make_ten_split_leftover,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           nonnegative_integer_sum).
action_automaton_signature(addition, make_ten_drop_leftover,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           incorrect_nonnegative_integer_sum).
action_automaton_signature(addition, count_all_when_count_on_available,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           nonnegative_integer_sum).
action_automaton_signature(addition, column_addition_with_carrying,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           nonnegative_integer_sum).
action_automaton_signature(addition, known_fact_retrieval,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           nonnegative_integer_sum).
action_automaton_signature(addition, count_all_instead_of_known_fact,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           nonnegative_integer_sum).
action_automaton_signature(addition, round_without_adjusting,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           incorrect_nonnegative_integer_sum).
action_automaton_signature(addition, make_base_transfer,
                           inputs(nonnegative_integer_addend,
                                  nonnegative_integer_addend),
                           nonnegative_integer_sum).
action_automaton_signature(subtraction, count_up_missing_addend,
                           inputs(nonnegative_integer_minuend,
                                  nonnegative_integer_subtrahend),
                           nonnegative_integer_difference).
action_automaton_signature(subtraction, decompose_base_for_ones,
                           inputs(nonnegative_integer_minuend,
                                  nonnegative_integer_subtrahend),
                           nonnegative_integer_difference).
action_automaton_signature(subtraction, take_away_base_ones,
                           inputs(nonnegative_integer_minuend,
                                  nonnegative_integer_subtrahend),
                           nonnegative_integer_difference).
action_automaton_signature(subtraction, compare_by_matching_difference,
                           inputs(nonnegative_cardinality,
                                  nonnegative_cardinality),
                           nonnegative_cardinality_difference).
action_automaton_signature(subtraction, add_instead_of_subtract_column,
                           inputs(nonnegative_integer_minuend,
                                  nonnegative_integer_subtrahend),
                           incorrect_nonnegative_integer_difference).
action_automaton_signature(subtraction, smaller_from_larger_in_column,
                           inputs(nonnegative_integer_minuend,
                                  nonnegative_integer_subtrahend),
                           incorrect_nonnegative_integer_difference).
action_automaton_signature(subtraction, answer_as_endpoint_count_up,
                           inputs(nonnegative_integer_minuend,
                                  nonnegative_integer_subtrahend),
                           endpoint_as_incorrect_difference).
action_automaton_signature(multiplication, repeat_equal_groups,
                           inputs(positive_integer_group_count,
                                  positive_integer_group_size),
                           nonnegative_integer_product).
action_automaton_signature(multiplication, distribute_group_size_split,
                           inputs(positive_integer_group_count,
                                  positive_integer_group_size),
                           nonnegative_integer_product).
action_automaton_signature(multiplication, multiplication_fact_retrieval,
...
action_automaton_signature(multiplication,
                           ...
                           inputs(positive_integer_factor,
                                  positive_integer_factor),
                           nonnegative_integer_product).
action_automaton_signature(multiplication, coordinate_groups_items,
                           inputs(positive_integer_group_count,
                                  positive_integer_group_size),
                           nonnegative_integer_product).
action_automaton_signature(multiplication,
                           ...
                           inputs(positive_integer_group_count,
                                  positive_integer_group_size),
                           nonnegative_integer_product).
action_automaton_signature(multiplication, repeat_group_size_by_itself,
                           inputs(positive_integer_group_count,
                                  positive_integer_group_size),
                           incorrect_nonnegative_integer_product).
action_automaton_signature(division, fair_share_equal_groups,
                           inputs(nonnegative_integer_total,
                                  positive_integer_group_count),
                           equal_share_size).
action_automaton_signature(division, measure_groups_of_size,
                           inputs(nonnegative_integer_total,
                                  positive_integer_group_size),
...
action_automaton_signature(division, share_into_divisor_groups,
                           ...
                           remainder_insensitive_share_size).
action_automaton_signature(division, partial_quotient_chunking,
                           inputs(nonnegative_integer_dividend,
                                  positive_integer_divisor),
                           integer_quotient_and_remainder).
action_automaton_signature(division, name_group_count_as_share_size,
                           inputs(nonnegative_integer_total,
                                  positive_integer_group_count),
                           group_count_as_incorrect_share_size).
action_automaton_signature(division, long_division,
                           inputs(nonnegative_integer_dividend,
                                  positive_integer_divisor),
                           long_division_quotient_and_remainder).
action_automaton_signature(division, missing_factor_repeated_addition,
                           inputs(nonnegative_integer_total,
                                  positive_integer_factor),
                           integer_quotient).
action_automaton_signature(division, name_reached_total_as_quotient,
                           inputs(nonnegative_integer_total,
                                  positive_integer_factor),
                           reached_total_as_incorrect_quotient).
action_automaton_signature(division, stop_after_first_partial_quotient,
                           inputs(nonnegative_integer_dividend,
                                  positive_integer_divisor),
                           incomplete_integer_quotient_and_remainder).
action_automaton_signature(fraction, unit_fraction_partition,
                           inputs(unit_iteration_count_one,
                                  positive_integer_denominator),
                           unit_fraction).
action_automaton_signature(fraction, unit_fraction_iteration,
                           inputs(positive_integer_iteration_count,
                                  positive_integer_denominator),
                           fraction_value).
action_automaton_signature(fraction, co_denominator_make_base_transfer,
...
action_automaton_signature(fraction,
                           ...
                           inputs(same_denominator_fraction_pair,
                                  referent_whole),
                           co_denominator_fraction_sum).
action_automaton_signature(fraction, improper_fraction_chain_loss,
                           inputs(improper_fraction_iteration_count,
                                  positive_integer_denominator),
                           reset_fraction_with_lost_referent).
action_automaton_signature(fraction, measurement_division,
                           inputs(positive_fraction_dividend_divisor_pair,
                                  referent_whole),
                           fraction_quotient_and_remainder).
action_automaton_signature(fraction, reversible_measurement_division,
                           inputs(positive_fraction_dividend_divisor_pair,
                                  referent_whole),
                           fraction_quotient).
