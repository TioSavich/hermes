...
van_hiele_bootstrap_witness(Id,
    WitnessDict187) :-
    witness_dict:witness_dict(van_hiele_transition_activity, closed_world_finite_van_hiele_transition_table,
                              _{id: Id,
       concept: Concept,
       kind_of_record: Kind,
       ...
       fact: bootstrap(Id, Concept, Kind, Description, Materials, Transition) }, WitnessDict187),
...
van_hiele_material_inference_witness(Concept,
                                     ...
                                     Polarity,
                                     Witness) :-
    witness_dict:witness_dict(van_hiele_material_inference, closed_world_finite_van_hiele_transition_table,
                              _{claim_id: Id,
                 concept: Concept,
                 premise: Premise,
