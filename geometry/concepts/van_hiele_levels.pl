...
van_hiele_level_material_claim_witness(Id, Witness) :-
    witness_dict:witness_dict(geometry_van_hiele_level_material_inference, closed_world_finite_van_hiele_level_anchor_table,
                              _{id: Id,
                 ...
                 fact: material_inference(LevelConcept, Premise, Target, Polarity) }, WitnessDict41),
