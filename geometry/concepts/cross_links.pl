...
% phenomenon and concept B owns the misconceptions/markers/bootstraps for
...
cross_link_witness(Source,
                   ...
                   Target,
                   Status,
                   _{ kind: geometry_cross_link,
                      scope: closed_world_finite_geometry_cross_link_table,
                      source: Source,
                      relation: Relation,
                      target: Target,
                      status: Status,
...
cross_link_material_inference_witness(Source,
                                      ...
                                      Target,
                                      Polarity,
                                      _{ kind: geometry_cross_link_material_inference,
                                         scope: closed_world_finite_geometry_cross_link_table,
                                         source: Source,
                                         premise: Premise,
                                         target: Target,
