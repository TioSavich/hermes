...
candidates JSON that representation/build_asset_manifest.py picks up.
...
Run from the repo root:
    python3 representation/extract_literature_figures.py            # figure pages
    python3 representation/extract_literature_figures.py --all      # + topic-only pages
    python3 representation/extract_literature_figures.py --dpi 120  # smaller files
"""
