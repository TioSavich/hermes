 ...
 * `pml/mua_relations.pl`. The MUA module's `grounding_metaphor/2`
 ...
 *   - pml/mua_relations.pl (authoritative practice ids and
...
%% `pml/mua_relations.pl`. Not exhaustive; each entry records a
...
%% Bridge to MUA layer
%%
%% Thin glue predicate. `pml/mua_relations.pl` is authoritative for
...
%   `pml/mua_relations.pl`, returns the corresponding full metaphor id
