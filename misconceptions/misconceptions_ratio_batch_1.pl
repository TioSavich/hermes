:- module(misconceptions_ratio_batch_1, []).
% ratio misconceptions — direct solo batch 1.
...
r37647_sample_size_changes_taste(samples_same_mixture(7, 4), different_strengths).
...
r37649_numerical_overrides_invariance(samples_same_mixture_with_amounts, not_same).
...
r37831_additive_difference_for_ratio(compare_steps(42, 21), additive_difference(21)).
...
r37991_additive_gap_equivalence(compare_ratios(ratio(6,4), ratio(8,6)), equivalent).
...
r38487_subtract_unit_group_for_ratio(teachers_needed(25, kids_per_teacher(5)), 20).
...
r38488_additive_ratio_extension(missing_ratio_term(ratio(5,3), first_to(10)), 8).
...
r38502_add_ratio_parts_keep_one_whole(combine_scores(score(6,25), score(8,25)), frac(14,25)).
...
r39638_additive_gap_same_flavour(compare_mixtures(ratio(3,5), ratio(4,6)), same).
...
r39701_first_component_only_compare(compare_mixtures(ratio(3,5), ratio(2,3)), stronger).
...
r39714_context_ignored_for_ratio(face_to_hand_ratio(0.1), possible).
