...
%
%       When the goal is routed through formal/learner/meta_interpreter.pl:solve/6,
...
%
%       Local copy of the cost table. Kept in sync with formal/learner/config.pl's
...
%       fact-sheet; the canonical values live in formal/learner/config.pl.
cost_for_action(Action, Cost) :-
