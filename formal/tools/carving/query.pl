...
exploratory_carving_artifact(batch_runner, 'formal/tools/carving/run.pl').
exploratory_carving_artifact(batch_analyzer, 'formal/tools/carving/analyze.py').
exploratory_carving_artifact(batch_analyzer, 'formal/tools/carving/analyze_sweep.py').
exploratory_carving_artifact(batch_analyzer, 'formal/tools/carving/recovery_audit.py').
