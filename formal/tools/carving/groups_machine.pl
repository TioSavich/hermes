 ...
 * machine (formal/tools/carving/strategy_machine.pl) and the fraction machine
 * (formal/tools/carving/fraction_unit_machine.pl). The unifying primitive across all
