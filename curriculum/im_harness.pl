 ...
 * (curriculum/im/grade_*.pl: explicit_lesson_strategy/4, explicit_lesson_misconception/4,
 ...
 *
 * Run: swipl -q -l paths.pl -s curriculum/tests/test_im_harness.pl -g run_tests -t halt
 */
:- module(im_harness,
