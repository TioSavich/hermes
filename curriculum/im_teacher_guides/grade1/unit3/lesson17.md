# Make 10 to Add
_Anchor ID: `IM-G1-U3-L17` — Grade grade1, Unit 3, Lesson 17_

## Learning Goals (teacher-facing)
- Describe (orally) patterns when adding one-digit numbers to 9.
- Explain (orally) strategies for solving Put Together, Total Unknown problems within 20 that involve making a ten.
...
Addressing     1.OA.A.1, 1.OA.B.3, 1.OA.C.6                      • How Many Do You See?



     Goals                                                           Student Facing Learning Goals
  • Describe (orally) patterns when adding one-digit                 Let’s look for patterns and think about making 10 as
    numbers to 9.                                                    we add.
  • Explain (orally) strategies for solving Put Together,
    Total Unknown problems within 20 that involve
    making a ten.


Lesson Purpose
The purpose of this lesson is for students to look for and use patterns to add within 20. Students see that they can
decompose one addend in order to make a ten.
...
Student methods are recorded with equations. It may also be helpful to represent how one addend is decomposed in
order to make a ten.
...
    in the top. So, 9 and 1 is 10.                               Activity Synthesis
  • 15: I took one from the 6 and added it to the 9 to
    ...
    make 10. So, 10 and 5 is 15.
                                                                     different words?”
  • 15: I saw 2 fives to make a ten and 2 and 3 is 5. So, 10
    and 5 is 15.
...
Students may generalize that when they take one from an addend to make 10, the sum has one less one than
that addend. When students build this understanding, they may no longer need to show their thinking on the 10-frame
and can just write an equation. By repeatedly making the 10 by taking one from an addend, students may see and use
the structure of 10 to add on (MP7, MP8).


      Access for Students with Disabilities
      Engagement: Internalize Self-Regulation. Synthesis: Provide students an opportunity to self-assess and reflect on
      their own progress. For example, ask students how comfortable they are adding different numbers to 9.
...
Clare’s Birds
     ...
     Standards
Addressing     1.OA.A.1, 1.OA.B.3, 1.OA.C.6


The purpose of this activity is for students to solve addition story problems in which one addend is close to 10. Students
may use any method or representation that makes sense to them. During the Synthesis, the double 10-frame is used to
visually show decomposing one addend to make 10 with the other (the associative property).


      Access for English Language Learners
      MLR7 Compare and Connect. Synthesis: After all methods have been presented, lead a discussion comparing,
      contrasting, and connecting the different approaches. Ask, “How are the different strategies similar? How are they
      different?”
...
Materials to Gather
  ...
  • Double 10-frames: Activity 2
     ...
     Student Task Statement                                    Launch
       1. Clare draws some birds.                                • Groups of 2
          She draws 3 birds in a nest and 9 birds flying.        • Give students access to double 10-frames and
          How many birds did she draw?                             connecting cubes or two-color counters.
          Show your thinking using drawings, numbers,
          or words.
                                                               Activity
       2. Clare draws birds that like warm weather.
          She draws 6 toucans and 8 parrots.                     • Read the Task Statement.
          How many birds did she draw?
                                                                 • 4 minutes: independent work time
          Show your thinking using drawings, numbers,
          or words.                                              • 3 minutes: partner discussion
                                                                 • Monitor for students who use these methods for the
       3. Clare draws birds that like cold weather.
                                                                   second problem:
          She draws 7 penguins and 5 owls.
          How many birds did she draw?                               ◦ Show 6, show 8 more, and count all.
          Show your thinking using drawings, numbers,                ◦ Show 8, and count on 6.
          or words.
...
Student Response                                                   ◦ 6 + 4 = 10, 10 + 4 = 14
                                                                   ◦ 8 + 2 = 10, 10 + 4 = 14
 1. 12 birds. Sample response: I showed 9 on the
    10-frame and added 3 more. I saw that is 12.
 2. 14 birds. Sample response: I started with 8 circles.
    Then I drew 6 more circles. I circled 8 and 2 to make
    10. Now I have 10 and 4. That’s 14.
 3. 12 birds. Sample response: I showed 7 red counters
    on the top 10-frame. I added 3 yellow counters to
    make 10. Then I put the last 2 yellow counters on the
    other 10-frame. That is 12.
