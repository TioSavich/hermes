...
%   for K-5 and from curriculum/scope_and_sequence for grades 6-8.
...
scope_sequence_file(6, 'curriculum/scope_and_sequence/grade6.md').
scope_sequence_file(7, 'curriculum/scope_and_sequence/grade7.md').
scope_sequence_file(8, 'curriculum/scope_and_sequence/grade8.md').
