 ...
 *   - knowledge/geometry/metaphors/lakoff_nunez_inventory.pl, measuring_stick.pl
...
%   inventory already names (knowledge/geometry/metaphors/lakoff_nunez_inventory.pl:
