 ...
 * fraction. ADDITIVE over knowledge/strategies/render/representation_grammar.pl: it does
 ...
 * in knowledge/strategies/render/attested_deformations.pl.
 *
 ...
 * (knowledge/strategies/render/attested_deformations.pl attested_transplant/5,
