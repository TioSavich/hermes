...
run_fraction_action(number_line_count_marks_not_intervals,
    ...
    comparison_viability(Expected, Result,
                         mark_count_order_agrees_with_interval_measure,
                         mark_count_order_diverges_from_interval_measure,
                         Viability),
...
run_fraction_action(area_model_unequal_partition_piece_count,
    ...
    comparison_viability(Expected, Result,
                         piece_count_order_agrees_with_fraction_magnitude,
                         piece_count_order_diverges_from_fraction_magnitude,
                         Viability),
    viability_validity(Viability, Validity),
...
run_fraction_action(set_model_subset_size_focus,
    ...
    comparison_viability(Expected, Result,
                         subset_size_order_agrees_with_fraction_magnitude,
                         subset_size_order_diverges_from_fraction_magnitude,
                         Viability),
    viability_validity(Viability, Validity),
...
run_fraction_action(add_numerator_denominator_comparison,
    ...
    comparison_viability(Expected, Result,
                         ...
                         numerator_denominator_sum_order_diverges_from_common_unit_order,
                         Viability),
    viability_validity(Viability, Validity),
...
run_fraction_action(co_denominator_count_on_from_larger,
    ...
    CGIOutcome = action_outcome(_, CGIFields),
    member(result(Result), CGIFields),
    Outcome = action_outcome(
...
comparison_viability(Expected, Expected, CoincidenceCondition, _,
                     viability(contextual_success,
                               condition(CoincidenceCondition),
                               validity(contextually_correct))) :-
    !.
comparison_viability(Expected, Produced, _, DivergenceCondition,
