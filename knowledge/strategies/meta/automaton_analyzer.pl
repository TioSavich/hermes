...
strategy_registry('COBO',                  '+', sar_add_cobo,              'knowledge/strategies/math/sar_add_cobo.pl').
strategy_registry('Chunking',              '+', sar_add_chunking,          'knowledge/strategies/math/sar_add_chunking.pl').
strategy_registry('RMB',                   '+', sar_add_rmb,               'knowledge/strategies/math/sar_add_rmb.pl').
strategy_registry('Rounding',              '+', sar_add_rounding,          'knowledge/strategies/math/sar_add_rounding.pl').
strategy_registry('COBO (Missing Addend)', '-', sar_sub_cobo_missing_addend, 'knowledge/strategies/math/sar_sub_cobo_missing_addend.pl').
strategy_registry('CBBO (Take Away)',      '-', sar_sub_cbbo_take_away,    'knowledge/strategies/math/sar_sub_cbbo_take_away.pl').
strategy_registry('Decomposition',         '-', sar_sub_decomposition,     'knowledge/strategies/math/sar_sub_decomposition.pl').
strategy_registry('Sub Rounding',          '-', sar_sub_rounding,          'knowledge/strategies/math/sar_sub_rounding.pl').
strategy_registry('Sliding',               '-', sar_sub_sliding,           'knowledge/strategies/math/sar_sub_sliding.pl').
strategy_registry('Chunking A',            '-', sar_sub_chunking_a,        'knowledge/strategies/math/sar_sub_chunking_a.pl').
strategy_registry('Chunking B',            '-', sar_sub_chunking_b,        'knowledge/strategies/math/sar_sub_chunking_b.pl').
strategy_registry('Chunking C',            '-', sar_sub_chunking_c,        'knowledge/strategies/math/sar_sub_chunking_c.pl').
strategy_registry('C2C',                   '*', smr_mult_c2c,              'knowledge/strategies/math/smr_mult_c2c.pl').
strategy_registry('CBO',                   '*', smr_mult_cbo,              'knowledge/strategies/math/smr_mult_cbo.pl').
strategy_registry('Commutative Reasoning', '*', smr_mult_commutative_reasoning, 'knowledge/strategies/math/smr_mult_commutative_reasoning.pl').
strategy_registry('DR',                    '*', smr_mult_dr,               'knowledge/strategies/math/smr_mult_dr.pl').
strategy_registry('CGOB',        '/', smr_div_cbo,               'knowledge/strategies/math/smr_div_cbo.pl').
strategy_registry('Dealing by Ones',       '/', smr_div_dealing_by_ones,   'knowledge/strategies/math/smr_div_dealing_by_ones.pl').
strategy_registry('IDP',                   '/', smr_div_idp,               'knowledge/strategies/math/smr_div_idp.pl').
strategy_registry('UCR',                   '/', smr_div_ucr,               'knowledge/strategies/math/smr_div_ucr.pl').
...
surface_uncovered :-
    findall(Path,
            ( expand_file_name('knowledge/strategies/math/*.pl', Paths),
              member(Path, Paths)
            ),
            AllPaths),
