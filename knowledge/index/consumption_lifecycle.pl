...
store_lifecycle('knowledge/index/coverage_absence_registry.pl', runtime_lazy, 'knowledge/index/index_query.pl', '2026-08-22', "index_query loads the registry and serves metaphor renderer receipts through the worker").
...
store_lifecycle('knowledge/index/task_span_absence_registry.pl', runtime_lazy, 'knowledge/index/index_query.pl', '2026-08-22', "index_query serves lesson rollups while task_span_lesson_dict also reads lesson reason counts without a separate sentinel").
...
consumption_probe('knowledge/index/coverage_absence_registry.pl', consumer_goal, probe(load('knowledge/index/index_query.pl'), store_fact('knowledge/index/coverage_absence_registry.pl', coverage_absence_registry:coverage_receipt(metaphor(Metaphor), renderer, coverage_gap(_), _Evidence)), index_query:metaphor_coverage_dict(Metaphor, Dict), nonvar(Dict))).
...
consumption_probe('knowledge/index/task_span_absence_registry.pl', consumer_goal, probe(load('knowledge/index/index_query.pl'), store_fact('knowledge/index/task_span_absence_registry.pl', task_span_absence_registry:lesson_task_span_rollup(Lesson, _Grade, _Spans, _Resolved, _Readiness, _PrimaryBlocker)), index_query:task_span_lesson_dict(Lesson, Dict), nonvar(Dict))).
