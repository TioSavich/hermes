/** <module> Combinatorial misconception table
 *
 * This table holds literature-attested combinatorial misconception registrations
 ...
 * is the archive.
 */
:- module(misconceptions_combinatorial, []).
...
misconceptions_combinatorial_batch_1:r37461_cartesian_product_one_to_one(outfits(3, 4), 3).
...
misconceptions_combinatorial_batch_1:r37463_drop_dimension(three_bag_choices(4, 4, 4), 16).
...
misconceptions_combinatorial_batch_1:r38219_overlap_overcount(at_least_three_es(length(4), alphabet(26)), 104).
...
misconceptions_combinatorial_batch_1:r38336_two_dimensional_product(three_bag_choices(4, 4, 4), 16).
...
misconceptions_combinatorial_batch_1:r38338_blind_combine_numbers(coin_die(2, 6), 36).
...
misconceptions_combinatorial_batch_1:r38471_empty_set_as_singleton(classify_pizza(plain), one_topping).
...
misconceptions_combinatorial_batch_1:r38518_double_count_new_intersection(extend_square_array(7, 8), 16).
...
misconceptions_combinatorial_batch_1:r38706_arrangement_as_combination_sum(two_stripe_flags(15), 120).
...
misconceptions_combinatorial_batch_1:r38707_square_initial_term_for_sum(decreasing_sum_from(15), 225).
...
misconceptions_combinatorial_batch_1:r38817_complement_symmetry_missed(compare_committees(8, 2, 6), more_two_person).
...
misconceptions_combinatorial_batch_1:r39967_choose_notation_as_fraction(choose(8, 2), frac(8, 2)).
