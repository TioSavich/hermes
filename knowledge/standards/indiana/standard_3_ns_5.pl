...
fraction_comparison_witness(fraction(NA, DA),
                            ...
                            RuleWitness,
                            WitnessDict106) :-
    witness_dict:witness_dict(standard_3_ns_5_fraction_comparison, closed_world_finite_standard_3_ns_5_fraction_comparison,
                              _{standard: in_3_ns_5,
                               ...
                               incompatibility_witness: IncompatibilityWitness }, WitnessDict106),
