...
comparison_witness(A,
                   ...
                   PlaceWitness,
                   WitnessDict86) :-
    witness_dict:witness_dict(standard_2_ns_5_place_value_comparison, closed_world_finite_standard_2_ns_5_place_value,
                              _{standard: in_2_ns_5,
                      ...
                      boundary: supplied_grounded_recollections_only }, WitnessDict86),
