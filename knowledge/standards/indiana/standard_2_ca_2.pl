...
addition_witness(A, B, Sum,
                 ...
                 OnesRegroup, TensRegroup, CompositionWitness,
                 WitnessDict412) :-
    witness_dict:witness_dict(standard_2_ca_2_place_value_addition, closed_world_finite_standard_2_ca_2_operations_within_1000,
                              _{standard: in_2_ca_2,
                    ...
                    bound_status: BoundStatus }, WitnessDict412),
...
subtraction_witness(A, B, Difference,
                    ...
                    CompositionWitness,
                    WitnessDict456) :-
    witness_dict:witness_dict(standard_2_ca_2_place_value_subtraction, closed_world_finite_standard_2_ca_2_operations_within_1000,
                              _{standard: in_2_ca_2,
                       ...
                       boundary: supplied_grounded_recollections_with_finite_three_place_decomposition,
                       bound_status: BoundStatus }, WitnessDict456),
    recollection_to_integer(A, ACount),
    recollection_to_integer(B, BCount),
...
cobo_witness(A, B, Sum, DecompositionB, Steps,
             WitnessDict487) :-
    witness_dict:witness_dict(standard_2_ca_2_cobo_addition, closed_world_finite_standard_2_ca_2_operations_within_1000,
                              _{standard: in_2_ca_2,
                ...
                bound_status: BoundStatus }, WitnessDict487),
    recollection_to_integer(A, ACount),
    recollection_to_integer(B, BCount),
    recollection_to_integer(Sum, SumCount),
    operation_bound_status(SumCount, BoundStatus).
...
decompose_subtraction_witness(A, B, Difference, DecompositionB, Steps,
                              WitnessDict505) :-
    witness_dict:witness_dict(standard_2_ca_2_decomposition_subtraction, closed_world_finite_standard_2_ca_2_operations_within_1000,
                              _{standard: in_2_ca_2,
                                 ...
                                 bound_status: BoundStatus }, WitnessDict505),
    recollection_to_integer(A, ACount),
    recollection_to_integer(B, BCount),
    recollection_to_integer(Difference, DifferenceCount),
    operation_bound_status(DifferenceCount, BoundStatus).
