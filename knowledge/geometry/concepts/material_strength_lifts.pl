...
strength_inference_witness(Domain,
                           ...
                           inference(Domain, Stronger, Weaker, entitled, Detail),
                           WitnessDict751) :-
    witness_dict:witness_dict(material_strength_inference, closed_world_finite_material_strength_table,
                              _{status: entitled,
                              domain: Domain,
                              stronger: Stronger,
                              weaker: Weaker,
                              ...
                              weaker_profile: WeakerProfile }, WitnessDict751),
    stronger_than(Domain, Stronger, Weaker),
...
strength_inference_witness(Domain,
    ...
    witness_dict:witness_dict(material_strength_inference, closed_world_finite_material_strength_table,
                              ...
                              stronger_profile: StrongerProfile,
                              weaker_profile: WeakerProfile }, WitnessDict784),
    strength_term(Domain, Stronger),
    strength_term(Domain, Weaker),
    strength_profile(Domain, Stronger, StrongerProfile),
    strength_profile(Domain, Weaker, WeakerProfile),
...
validated_strength_lift_witness(Id,
    lift(Id, SourceConcept, Premise, Conclusion, Polarity, Domain, Stronger, Weaker, SourceNote, StrengthInference),
    WitnessDict1763) :-
    witness_dict:witness_dict(validated_strength_lift, closed_world_finite_material_strength_table,
                              _{id: Id,
       ...
       strength_inference_witness: StrengthWitness }, WitnessDict1763),
...
source_material_inference_witness(SourceConcept,
                                  ...
                                  Polarity,
                                  WitnessDict1784) :-
    witness_dict:witness_dict(source_material_inference, closed_world_finite_geometry_kb,
                              _{source_concept: SourceConcept,
                                     premise: Premise,
                                     conclusion: Conclusion,
                                     polarity: Polarity,
...
explicit_strength_lift_covers_witness(SourceConcept,
                                      ...
                                      Polarity,
                                      WitnessDict1875) :-
    witness_dict:witness_dict(explicit_strength_lift_cover, closed_world_finite_material_strength_table,
                              _{source_concept: SourceConcept,
                                         premise: Premise,
                                         conclusion: Conclusion,
                                         polarity: Polarity,
                                         lift_id: Id,
                                         lift_witness: LiftWitness }, WitnessDict1875),
    validated_strength_lift_witness(Id,
                                    lift(Id,
                                         SourceConcept,
                                         Premise,
...
structural_strength_lift_covers_witness(quadrilateral_hierarchy,
                                        shape(quadrilateral_object, Stronger),
                                        shape(quadrilateral_object, Weaker),
                                        entitled,
                                        WitnessDict1900) :-
    witness_dict:witness_dict(structural_strength_lift_cover, closed_world_finite_material_strength_table,
                              _{source_concept: quadrilateral_hierarchy,
                                           premise: shape(quadrilateral_object, Stronger),
                                           conclusion: shape(quadrilateral_object, Weaker),
                                           polarity: entitled,
                                           source: quadrilateral_restriction_table,
                                           strength_inference_witness: StrengthWitness }, WitnessDict1900),
...
structural_strength_lift_covers_witness(quadrilateral_hierarchy,
                                        shape(quadrilateral_object, Stronger),
                                        neg(shape(quadrilateral_object, Weaker)),
                                        incompatible,
                                        WitnessDict1917) :-
    witness_dict:witness_dict(structural_strength_lift_cover, closed_world_finite_material_strength_table,
                              _{source_concept: quadrilateral_hierarchy,
                                           premise: shape(quadrilateral_object, Stronger),
                                           conclusion: neg(shape(quadrilateral_object, Weaker)),
                                           polarity: incompatible,
                                           source: quadrilateral_restriction_table,
                                           strength_inference_witness: StrengthWitness }, WitnessDict1917),
    strength_inference_witness(quadrilateral_class,
                               Stronger,
                               Weaker,
                               _StrengthInference,
...
structural_strength_lift_covers_witness(quadrilateral_incompatibility,
                                        shape(quadrilateral_object, Shape),
                                        restriction(quadrilateral_object, Restriction),
                                        incompatible,
                                        WitnessDict1934) :-
    witness_dict:witness_dict(structural_strength_lift_cover, closed_world_finite_material_strength_table,
                              _{source_concept: quadrilateral_incompatibility,
                                           premise: shape(quadrilateral_object, Shape),
                                           conclusion: restriction(quadrilateral_object, Restriction),
                                           polarity: incompatible,
                                           source: quadrilateral_restriction_table,
                                           rejected_restriction_witness: RestrictionWitness }, WitnessDict1934),
...
strength_lift_coverage_witness(
    ...
    WitnessDict1969) :-
    witness_dict:witness_dict(strength_lift_coverage, closed_world_finite_material_strength_table,
                              _{counts: _{ total_material_inferences: TotalFacts,
                  flat_lifts: FlatLifts,
                  valid_lifts: ValidLifts,
                  structural_lifts: StructuralLifts,
       ...
       unlifted_witnesses: UnliftedWitnesses }, WitnessDict1969),
    witness_dict:witness_dict(unlifted_material_inference, closed_world_finite_material_strength_table,
                              _{source_concept: Concept,
                           premise: Premise,
                           conclusion: Conclusion,
                           polarity: Polarity,
