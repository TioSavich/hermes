...
dispatch_spec(axiom_pack_witness,
    ...
    call(cw_driver:family_witness,
         [const(cw_axiom_pack), const(axiom_pack_witness), pack, source, out(witness)]),
    witness(no_axiom_pack_witness)).
dispatch_spec(viability_witness,
    [resources-number, cost-number, source-term],
    call(cw_driver:family_witness,
         [const(cw_viability), const(viability_witness), resources, cost, source, out(witness)]),
    witness(no_viability_witness)).
dispatch_spec(modal_context_witness,
    [term-term, context-term, source-term],
    call(cw_driver:family_witness,
         [const(cw_modal_context), const(modal_context_witness), term, context, source, out(witness)]),
    witness(no_modal_context_witness)).
dispatch_spec(grounded_arith_witness,
    [operation-atom, inputs-term, output-term, source-atom],
    call(cw_driver:family_witness,
         [const(cw_grounded_arith), const(grounded_arith_witness), operation, inputs, output, source, out(witness)]),
...
dispatch_spec(material_inference_witness,
    ...
    call(cw_driver:family_witness,
         [const(cw_material_inference), const(material_inference_witness), inference_id, premises, conclusion, source, out(witness)]),
    witness(no_material_inference_witness)).
dispatch_spec(normative_crisis_witness,
    [context-term, goal-term, source-term],
    call(cw_driver:family_witness,
         [const(cw_normative_crisis), const(normative_crisis_witness), context, goal, source, out(witness)]),
...
dispatch_spec(misconception_hook_witness,
    ...
    call(cw_driver:family_witness,
         [const(cw_misconception_hook), const(misconception_hook_witness), operation, outcome, family, drop, source, out(witness)]),
...
dispatch_spec(productive_deformation_witness,
    ...
    call(cw_driver:family_witness,
         [const(cw_productive_deformation), const(productive_deformation_witness), operation, productive, deformation, family, source, out(witness)]),
    witness(no_productive_deformation_witness)).
dispatch_spec(mua_coherence_witness,
    [subject-term, input-dict, source-term],
    call(cw_driver:family_witness,
         [const(cw_mua_coherence), const(mua_coherence_witness), subject, input, drop, source, out(witness)]),
...
dispatch_spec(mua_kind_coherence_witness,
    ...
    call(cw_driver:family_witness,
         [const(cw_mua_coherence), const(mua_coherence_source_witness), kind, row_text, drop, const(pml_vocabulary), out(witness)]),
