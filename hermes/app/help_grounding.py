...
PAGE_READMES: dict[str, tuple[str, ...]] = {
    ...
    "discussions": ("hermes/app/README.md", "pml/README.md"),
    "visualizations": ("strategies/render/README.md",),
    "witnesses": ("crosswalk/README.md", "standards/README.md", "pml/README.md", "geometry/README.md"),
    "monitoring": ("lessons/im/README.md",),
    "gallery": ("representation/README.md",),
    "landing": ("more-zeeman/README.md",),
    "no": ("arche-trace/README.md", "pml/README.md"),
    "breaks": ("arche-trace/README.md", "formalization/README.md"),
    ...
    "boundary": ("formalization/README.md", "strategies/README.md"),
    "matrix": ("more-zeeman/README.md",),
    "muds": ("pml/README.md",),
    "scoreboard": ("learner/README.md", "pml/README.md"),
    "atlas": ("hermes/README.md",),
    "bridge": ("learner/README.md",),
    "coordination": ("strategies/math/README.md",),
    "reorganization": ("learner/README.md",),
