...
PAGE_CONTEXT: dict[str, dict[str, str]] = {
    ...
    "sidekick": {"theme": "Norms & curriculum", "lede": "Chat with the local tuned model while every Hermes consultation it runs is listed beside the reply.", "path": "/hermes/app/web/sidekick.html", "theory": "/more-zeeman/landing.html"},
    ...
    "questions": {"theme": "Norms & curriculum", "lede": "Query the authored assessing and advancing questions by topic, automaton state, or standard.", "path": "/hermes/app/web/questions.html", "theory": "/more-zeeman/scoreboard.html"},
