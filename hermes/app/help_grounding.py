...
PAGE_CONTEXT: dict[str, dict[str, str]] = {
    ...
    "no": {"theme": "Incompatibility", "lede": "Work through how a rule succeeds in one domain and fails beyond it.", "path": "/hermes/app/web/no.html", "theory": "/hermes/app/web/no.html"},
    "breaks": {"theme": "Incompatibility", "lede": "Test where a grounding metaphor or incompatibility relation reaches its boundary.", "path": "/hermes/app/web/breaks.html", "theory": "/hermes/app/web/no.html"},
    "incompatibility-entailment": {"theme": "Incompatibility", "lede": "Work through declared incompatibilities and the entailments they support.", "path": "/more-zeeman/incompatibility-entailment.html", "theory": "/hermes/app/web/no.html"},
    ...
    "counting": {"theme": "Objects", "lede": "Follow the cost of counting by ones as the quantities grow.", "path": "/more-zeeman/counting.html", "theory": "/more-zeeman/counting.html"},
    ...
    "fractal": {"theme": "Objects", "lede": "Change the conditions in nested strategy machines and follow how a snap propagates.", "path": "/more-zeeman/fractal.html", "theory": "/more-zeeman/fractal.html"},
    ...
    "muds": {"theme": "Recollection", "lede": "Trace relations between mathematical uses and their vocabularies.", "path": "/more-zeeman/muds.html", "theory": "/more-zeeman/muds.html"},
    "scoreboard": {"theme": "Norms & curriculum", "lede": "Work with commitments, entitlements, and inferential strength on one scoreboard.", "path": "/more-zeeman/scoreboard.html", "theory": "/more-zeeman/scoreboard.html"},
    "atlas": {"theme": "Recollection", "lede": "Find what Hermes can do and open the page for each capability.", "path": "/more-zeeman/atlas.html", "theory": "/more-zeeman/landing.html"},
    "bridge": {"theme": "The learner", "lede": "Work through a learner's move from a resource limit to a revised strategy.", "path": "/more-zeeman/bridge.html", "theory": "/more-zeeman/bridge.html"},
...
PAGE_READMES: dict[str, tuple[str, ...]] = {
    ...
    "sidekick": ("hermes/app/SIDEKICK.md", "hermes/mcp/README.md"),
