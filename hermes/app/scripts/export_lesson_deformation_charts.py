...
OUT = REPO / "hermes" / "app" / "web" / "generated" / "lesson_deformation_charts"
...
# --- The node drawer.js harness, reused verbatim from export_parametric_
# deformations.py (filmstrip layout: title + per-frame panels). ----------------
...
const out=`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${rootW} ${rootH}" role="img" aria-label="${escapeXml(title||'lesson deformation monitoring chart')}">${body}</svg>\n`;
