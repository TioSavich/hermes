...
gallery surface (`hermes/web/gallery.html`, served at `/more-zeeman/gallery.html`)
fetches. Image paths in the manifest
...
Run from the repo root:
  ...
  python3 hermes/representation/build_asset_manifest.py \
...
OUT = os.path.join(HERE, "asset_manifest.json")
ASKTM_BINDINGS = os.path.join(HERE, "asktm_bindings_draft.json")
...
def main():
    ...
    manifest = {
        ...
        "generator": "hermes/representation/build_asset_manifest.py",
